...
val CoinLightColors = lightColors(
    primary = Slate800,
...
@Stable
class CoinColors(coinListingDivider : Color) {
    var coinListingDivider by mutableStateOf(coinListingDivider)
        private set


    fun update(other: CoinColors) {
        coinListingDivider = other.coinListingDivider
    }
}


val ListingDividerGrey = Color(0xFFF0F0F0)
