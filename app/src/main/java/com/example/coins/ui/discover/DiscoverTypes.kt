...
sealed class DiscoverListingCategory(val id: String,@StringRes val res : Int) {
    ...
    data class TopGainers(val a: Int = 0) : DiscoverListingCategory("top-gainers",R.string.top_gainers)
    data class TopLosers(val a: Int = 0) : DiscoverListingCategory("top-losers",R.string.top_losers)
